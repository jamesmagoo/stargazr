    ...
    return (
        <div>
            ...
            <div className='mt-3 text-center sm:mt-5'>
                <Dialog.Title
                    as='h3'
                    className='text-lg leading-6 font-medium text-white my-2'
                >
                    I already have an account
                </Dialog.Title>
                <div className='text-sm text-gray-400 mb-4 mt-2 '>
                    We support <a className='underline text-sm text-indigo-400' href='https://getalby.com/' target='blank'> Alby </a>
                    and <a className='underline text-sm text-indigo-400' href='https://chrome.google.com/webstore/detail/nos2x/kpgefcfmnafjgpblomihpgmejjdanjjp' target='blank'> Nos2x </a>
                    browser extensions.
                </div>
                <div className='w-full items-center mb-8 '>
                    <button
                        type='button'
                        onClick={handleLogin}
                        className='cursor cursor-pointer hover:shadow-xl transition duration-300 ease-in-out hover:scale-105 border-black border-2 text-black focus:ring-4 focus:outline-none focus:ring-lime-200 rounded-md shadow-sm px-4 py-2 bg-white text-base font-medium focus:ring-offset-2'
                    >
