...
const tabs = [
  ...
  { name: 'Everyone', href: '#', current: false },
  { name: 'Highlights', href: '#', current: false },
]
const team = [
  {
...
export default function ExplorerView({showCommentsSection, handleClose} : Props) {

  return (
    <Transition.Root show={showCommentsSection} as={Fragment}>
                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                    <div className="p-6">
                      <div className="flex items-start justify-between">
                        <Dialog.Title className="text-lg font-medium text-gray-900">Comments & Annotations</Dialog.Title>
                    ...
                    <div className="border-b border-gray-200">
                      <div className="px-6">
                        <div className="-mb-px flex space-x-6" x-descriptions="Tab component">
                          {tabs.map((tab) => (
                            <a
                              key={tab.name}
                              href={tab.href}
